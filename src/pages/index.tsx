    ...
    <Dashboard>
            ...
            <a href='#' className='w-full h-full block'>
              <div className='flex items-center justify-between px-4 py-6 space-x-4'>
                <div className='flex items-center'>
                  ...
                  <p className='text-sm text-gray-700 dark:text-white ml-2 font-semibold border-b border-gray-200'>Level 2 Ambassador</p>
                </div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 my-4'>
        <div className='w-full'>
          <div className='shadow-lg px-4 py-6 w-full bg-white dark:bg-gray-700 relative'>
            <p className='text-sm w-max text-gray-700 dark:text-white font-semibold border-b border-gray-200'>Project Reffered</p>
        ...
        <div className='w-full'>
          <div className='shadow-lg px-4 py-6 w-full bg-white dark:bg-gray-700 relative'>
            <p className='text-sm w-max text-gray-700 dark:text-white font-semibold border-b border-gray-200'>Project Paid</p>
            <div className='flex items-end space-x-2 my-6'>
        ...
        <div className='w-full'>
          <div className='shadow-lg px-4 py-6 w-full bg-white dark:bg-gray-700 relative'>
            <p className='text-sm w-max text-gray-700 dark:text-white font-semibold border-b border-gray-200'>New features</p>
            <div className='flex items-end space-x-2 my-6'>
              <p className='text-5xl text-black dark:text-white font-bold'>12</p>
        ...
        <div className='w-full'>
          <div className='shadow-lg px-4 py-6 w-full bg-white dark:bg-gray-700 relative'>
            <p className='text-sm w-max text-gray-700 dark:text-white font-semibold border-b border-gray-200'>Sign in</p>
            <div className='flex items-end space-x-2 my-6'>
        ...
        <div className='w-full'>
          <div className='shadow-lg px-4 py-6 w-full bg-white dark:bg-gray-700 relative'>
            <p className='text-sm w-max text-gray-700 dark:text-white font-semibold border-b border-gray-200'>Sales</p>
            <div className='flex items-end space-x-2 my-6'>
        ...
        <div className='w-full'>
          <div className='shadow-lg px-4 py-6 w-full bg-white dark:bg-gray-700 relative'>
            <p className='text-sm w-max text-gray-700 dark:text-white font-semibold border-b border-gray-200'>Maintenance</p>
            <div className='flex items-end space-x-2 my-6'>
